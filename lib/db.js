...
const DEFAULT_SETTINGS = {
  ...
  // Module visibility & sidebar order
  modules: {
    dashboard: true, orders: true, search: true, prep: true, production: true,
    packaging: true, inventory: true, scanner: true, barcode_scan: true,
    products: true, workshops: true, embroidery: true, accounts: true,
    reports: true, settings: true
  },
  sidebar_order: [
    'dashboard','orders','search','prep','production','packaging',
    'inventory','scanner','barcode_scan','products','workshops',
    'embroidery','accounts','reports','settings'
  ],
  // Preparation card designer
  card_designer: {
    show_image: true, show_order_number: true, show_product_name: true,
    show_sku: true, show_size: true, show_color: true, show_quantity: true,
    show_pieces_count: true, show_embroidery: true, show_production_notes: true,
    show_qr: true, show_barcode_text: true, show_stage: true,
    show_type_badge: true, show_checklist: true,
    default_layout: 12, margin_mm: 2, qr_size: 'medium'
  }
};
